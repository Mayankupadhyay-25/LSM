...
import Rating from "../../Components/student/Reating ";
      ...
      <div className="p-4 sm:p-10 md:grid md:grid-cols-2 gap-10 md:px-36">
        ...
        <div className="md:mt-10">
          {isPlayerData ? (
            <div>
              <YouTube
              videoId={isPlayerData.lectureUrl.split('/').pop()}
              iframeClassName="w-full aspect-video" />
              <div className=" flex justify-between items-center mt-1">
                <p>{isPlayerData.chapter}.{isPlayerData.lecture}.{isPlayerData.lectureTitle}</p>
